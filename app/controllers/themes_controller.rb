class ThemesController < ApplicationController
  ...
  def show
    ...
    @theme_sort_by_fav = theme_add_favcount.sort_by { |_, v| v }.reverse.to_h
  end
  ...
  def draft?
    ...
    # binding.pry
    # 本当は404NotFoundにしたい
    return unless (current_user.nil? || @user.id != current_user.id) && @theme.post_status.zero?
